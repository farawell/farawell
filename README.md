...
## **Research Interests**
Although my specific research domain remains to be precisely defined, my interests are broad:
* Task and Motion Planning (TAMP) and use of Behavior Trees (BT) for robust decision making
* LMMs (Large Multimodal Models) for intelligent decision making
* Robotic system for humanoids
